...
<form class="w-full" method="POST" action="{{ $route }}">
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
        <div class="w-full px-3">
            ...
            <input name="nom" value="{{ old("nom") ?? $centre->nom }}" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="name" type="text">
            <p class="text-gray-600 text-xs italic">{{ __("Nombre del centre") }}</p>
            @error("nom")
